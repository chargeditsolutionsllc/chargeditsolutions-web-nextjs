...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: IOH6gj--C9ML/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <Searchsvg2Icon
              className={classNames(projectcss.all, sty.svg__j1IS)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__eXngW)}
              role={"img"}
            />
          ),
